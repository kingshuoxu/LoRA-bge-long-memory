...
GENERIC_QUESTIONS = [
    ...
    ("地球绕太阳公转一周大约多久?", "365"), ("1加1等于几?", "2"),
    ("光合作用发生在植物的哪个器官?", "叶"), ("英语中'苹果'怎么拼?", "apple"),
    ("一周有几天?", "7"), ("冰在标准大气压下多少度融化?", "0"), ("中国的首都是哪里?", "北京"),
    ("三角形内角和是多少度?", "180"), ("月亮是行星还是卫星?", "卫星"),
    ("人体最大的器官是什么?", "皮肤"), ("光速大约是多少?", "30万"), ("莎士比亚是哪国人?", "英"),
    ("计算机的CPU全称是什么?", "中央处理器"), ("氧气在空气中大约占多少比例?", "21"),
    ("太阳系最大的行星是哪颗?", "木星"), ("水沸腾的温度是多少摄氏度?", "100"),
    ("中国的官方语言是什么?", "汉语"),
]
